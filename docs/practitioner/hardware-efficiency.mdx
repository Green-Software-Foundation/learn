...
<Quiz
  QuizList={[
    ...
    },
    {
      ...
      answers: [
        {
          text: "Extending its lifespan and reducing its usage",
          isCorrect: false,
        },
        {
          text: "Extending its lifespan and increasing its usage",
          isCorrect: true,
        },
        {
          text: "Reducing its lifespan and increasing its usage",
          isCorrect: false,
        },
      ],
    },
    ...
    },
    {
      ...
      answers: [
        {
          text: "Embodied carbon often accounts for more emissions than the emissions from the electricity powering the device",
          isCorrect: true,
        },
        {
