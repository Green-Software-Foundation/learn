...
Les professionnels du logiciel éco-responsable prennent la responsabilité de l’énergie consommée par leurs produits et les conçoivent pour consommer le moins possible. Nous devons nous assurer que, à chaque étape du processus, il y a le moins de gaspillage possible et que la majeure partie de l’énergie va à l’étape suivante.
...
### Combustibles fossiles et sources d’énergie riches en carbone
...
- Le logiciel éco-responsable prend la responsabilité de sa consommation d’électricité et est conçu pour consommer le moins possible.
...
- Comprendre cela donne aux praticiens des logiciels éco-responsables un meilleur aperçu de la façon dont leur application se comporte par rapport à la consommation d’énergie dans le monde réel.
...
<Quiz
  QuizList={[
    ...
    {
      question: "Quels sont quelques exemples de combustibles fossiles?",
      answers: [
    ...
    {
      question: "Que mesure le PUE (efficacité de l’utilisation de l’énergie)?",
      answers: [
        { text: "L'éfficacité énergétique des centres de données", isCorrect: true },
