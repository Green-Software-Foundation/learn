...
- **Énergie propre** - ne produit pas d’émissions de carbone, par exemple, le nucléaire
...
La relation entre la puissance et l’utilisation n’est pas proportionnelle. Mathématiquement parlant, la proportionnalité entre deux variables signifie que leurs ratios sont équivalents. Par exemple, à 0% d’utilisation, un ordinateur peut consommer 100W; à 50%, il consomme 180W; et à 100%, il consomme 200W. La relation entre la consommation d’énergie et l’utilisation n’est pas linéaire et ne passe pas par l’origine.
...
La consommation d’électricité en veille d’un ordinateur est **la quantité d’électricité consommée lorsqu’il est à l’état inactif**. La consommation d’électricité en veille varie selon la configuration et les composants matériels, mais tous les composants consomment de l’électricité en veille. C’est l’une des raisons pour lesquelles les PC, les ordinateurs portables et les appareils des utilisateurs finaux ont des modes d’économie d’énergie. Si l’appareil est inactif, il finira par déclencher un mode d’hibernation et mettra le disque et l’écran en veille ou changera même la fréquence du processeur. Ces modes d’économie d’énergie permettent de consommer moins d’électricité, mais ils ont d’autres contreparties, telles qu’un redémarrage plus lent lorsque l’appareil se met en route.

Les serveurs ne sont généralement pas configurés pour une forte économie d’énergie ni même minimale. De nombreux cas d’utilisation exécutés sur des serveurs exigent une capacité totale aussi rapidement que possible, car le serveur doit répondre à des demandes qui évoluent rapidement, ce qui conduit à de nombreux serveurs en mode inactif pendant les périodes de faible demande. Un serveur inactif a un coût carbone lié à la fois au carbone généré lors de sa fabrication et à son utilisation inefficace.

## Synthèse

- L’électricité est un substitut du carbone, donc la construction d’une application efficace énergétiquement équivaut à la construction d’une application qui est efficace en terme de consommation carbone.
...
<Quiz
  QuizList={[
    ...
    {
      question: "Quelle est l’unité d’énergie internationale?",
      answers: [
        {
          text: "Watts",
          isCorrect: false,
    ...
    {
      question: "Qu’est-ce que la consommation d’électricité en veille?",
      answers: [
        {
        ...
        {
          text: "L’électricité étant consommée par une application en veille",
          isCorrect: true,
        },
        {
