...
De plus, pour être un objectif de zéro émission, vous devez couvrir les émissions directes et indirectes, c.-à-d. les émissions de la chaîne d’approvisionnement (portées 1, 2 et 3). Par conséquent, toute votre chaîne de valeur doit être incluse dans la portée de votre objectif de zéro émission. Ceci est significatif puisque le scope 3 représente souvent la majorité des émissions.
...
<Quiz
  QuizList={[
    ...
    },
    {
      ...
      answers: [
        {
          text: "Les émissions des périmètres 1 à 3 doivent être compensées par des neutralisations ou des compensations",
          isCorrect: false,
        },
        {
          text: "Les émissions des périmètres 1 et 2 doivent être compensées par des neutralisations ou des compensations",
          isCorrect: true,
        },
        {
          text: "Les émissions des périmètres 1 à 2 et les voyages d’affaires du périmètre 3 doivent être compensées par des neutralisations ou des compensations",
          isCorrect: false,
        },
      ],
    },
