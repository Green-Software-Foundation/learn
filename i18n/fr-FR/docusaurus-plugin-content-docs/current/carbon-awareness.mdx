...
_Faire plus quand l'électricité est plus propre et moins quand l'électricité est plus carbonée._
...
La conscience du carbone émis est l'idée de faire davantage quand l’énergie provient de sources à faibles émissions de carbone et moins quand l’énergie provient de sources à forte teneur en carbone.
...
L'intensité carbone varie en fonction du lieu car certaines régions ont un mix énergétique composé de plus d’énergies propres que d’autres.
...
Il est nécessaire d'avoir un équilibre entre l'offre et la demande d'électricité à tout moment et c'est généralement la responsabilité du fournisseur de service.
...
Si vous avez soudainement besoin d'accéder à plus de puissance électrique - par exemple, vous devez allumer une lampe - cette énergie vient de la part marginale d'une centrale électrique. Cette part marginale peut être répartie, ce qui veut dire que ces centrales électriques sont souvent alimentées par des combustibles fossiles.

L'intensité carbone marginale est l'intensité carbone de la centrale électrique qui devrait être utilisée pour répondre à toute nouvelle demande.
...
Le modèle exact du marché varie à travers le monde mais globalement suit le même modèle.
...
1. **Acheter moins d'énergie à des centrales à combustibles fossiles.**

![alt_text](./images/10_marginal_CI_FR.png "image_tooltip")
L'énergie provenant des centrales à combustibles fossiles est généralement la plus chère, c'est donc la méthode privilégiée. Cela se traduit directement par une consommation moindre de combustibles fossiles.

2. **Acheter moins d'énergie provenant des sources renouvelables**.

   Les sources d'énergie renouvables étant les plus abordables, les fournisseurs préfèrent éviter cette option. Si une source renouvelable ne parvient pas à vendre toute son électricité, il faut se débarrasser du surplus.
...
- **Centre de données Google conscients du carbone** - Google a lancé un projet pour [sensibiliser au carbone certaines des charges de travail](https://blog.google/outreach-initiatives/sustainability/carbon-aware-computing-location/). Ils ont créé des modèles pour prédire l’intensité et la charge de travail dans le futur. Ils ont ensuite façonné des charges de travail à grande échelle pour qu'elles soient traitées quand et où l’intensité carbone est la plus faible, mais de manière à pouvoir encore gérer la charge attendue.
- **Microsoft Carbon Aware Windows** - [Microsoft a annoncé un projet pour rendre Windows 11 plus durable](https://www.techradar.com/news/windows-11-is-getting-an-eco-friendly-update-but-could-microsoft-do-more). Dans un premier temps, cela signifie exécuter des mises à jour Windows lorsque l’intensité carbone est plus faible.

### Adaptation de la demande

L'adaptation de la demande est la stratégie qui consiste à déplacer les traitements vers les régions - ou les périodes - où l’intensité carbone est la plus faible. Cependant, au lieu de déplacer la demande vers une région ou une heure différente, nous adaptons nos traitements pour correspondre à l’offre existante.
...
L'adaptation de la demande pour les applications conscientes du carbone dépend complètement de l'intensité carbone de l'offre. Lorsque le coût en carbone de l’exploitation de votre application devient élevé, définissez la demande en fonction de l'intensité carbone de l'offre. Cela peut être géré automatiquement, ou l’utilisateur peut faire un choix.
...
Un logiciel de visioconférence qui ajuste automatiquement la qualité du streaming en est un exemple. Plutôt que de diffuser en continu avec la meilleure qualité possible à tout moment, il réduit la qualité vidéo pour prioritiser l’audio lorsque la bande passante est faible.

Un autre exemple est le protocole TCP/IP. La vitesse de transfert augmente en réponse à la quantité de données diffusées sur le réseau.

Un troisième exemple est l’amélioration progressive avec les pages internet. L’expérience internet s’améliore en fonction des ressources et de la bande passante disponibles sur l’appareil de l’utilisateur final.
...
- La nature des combustibles fossiles et des sources d’énergies renouvelables signifie que la consommation d’énergie lorsque l’intensité carbone est faible augmente la demande de sources d’énergie renouvelables et augmente le pourcentage d’énergie renouvelable dans l’offre.
- Le décalage de la demande signifie déplacer votre consommation d’énergie à différents endroits ou à différents moments de la journée lorsque l’intensité carbone est inférieure.
- Adapter la demande signifie adapter votre consommation d’énergie en fonction de la variabilité de l’intensité carbone afin de consommer plus dans les périodes de faible intensité et moins dans les périodes de forte intensité.
  ...
  QuizList={[
    ...
    },
    {
      ...
      answers: [
        ...
        { text: "L’une ou l’autre des réponses ci-dessus", isCorrect: true },
      ],
    },
    {
      question: "Quelles sont les deux variables qui influent sur l’intensité carbone?",
      answers: [
        { text: "L'endroit et le moment", isCorrect: true },
        { text: "L'offre et la demande", isCorrect: false },
        { text: "Le moment et la demande", isCorrect: false },
      ],
    },
    {
      question:
    ...
    },
    {
      ...
      answers: [
        ...
        {
          text: "L'énergie qui est perdue en raison de l’offre excédentaire",
          isCorrect: true,
        },
