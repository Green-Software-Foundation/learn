...
Si vous ne pouvez pas déplacer votre calcul spatialement vers une autre région, une autre option est de passer à un autre moment. Peut-être plus tard dans la journée ou la nuit, lorsque le temps est plus ensoleillé ou plus venteux et que, par conséquent, l’intensité carbone est plus faible, ce qu’on appelle le déplacement temporel de la demande. Nous pouvons raisonnablement bien prédire l’intensité future du carbone grâce aux progrès des prévisions météorologiques.
...
La planification de la demande est la stratégie qui consiste à déplacer le calcul vers les régions ou les périodes où l’intensité carbone est la plus faible. Cependant, au lieu de déplacer la demande vers une région ou une heure différente, nous façonnons notre calcul pour correspondre à l’offre existante.
...
- La planification de la demande signifie déplacer votre consommation d’énergie à différents endroits ou à différents moments de la journée où l’intensité carbone est inférieure.
