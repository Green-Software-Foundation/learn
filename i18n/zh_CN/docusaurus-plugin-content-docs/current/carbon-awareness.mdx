...
并非所有的电力都以同样的方式生产。在不同的地点和时间，来源不同的电力，会带来不同的碳排放。诸如风能、太阳能或水力发电等来源的电力，是清洁的可再生能源，碳排放量很小。同事，化石燃料发电也会排放不同程度的碳。例如，天然气和煤炭的碳排放量都高于可再生能源，但天然气发电厂的碳排放量低于煤炭发电厂。
...
如果您的电脑能够直接接入风力发电的电网，其电力的碳强度为 0g CO2eq/kWh，因为风力发电厂在生产电力时不会排放任何碳。然而，大多数人并不能直接接入风力发电场的电网，而是接入电力来源不同的电网。
...
天气条件的不可预测性导致可再生能源天然具备可变性，故而碳强度也会随着时间的推移发生变化。例如，当阴天或无风时，碳强度就会增加，因为您的电力组合中会有更多的电力来自碳排放源。

![alt_text](./images/08_variability_CI.png "image_tooltip")

#### 可调度性与缩减

电力需求在一天中是变化的，而电力供应始终需要这种需求的变化。如果电力公司生产的电力不足以满足需求，就会出现灯火管制（电力线的电压水平下降）。相反，如果电力公司生产的电力超过了需求，为了防止基础设施烧毁，断路器就会跳闸，导致停电。
...
如果您突然需要获得更多电力，例如需要开灯，那么这些电能就来自边际发电厂。边际发电厂是可调度的，这意味着边际发电厂通常使用化石燃料供电。

边际碳强度是指为满足任何新需求而必须使用的发电厂的碳强度。
...
化石燃料本身是可调度的；它们可以通过增加燃烧速度提高能源产量。然而，煤炭成本高昂，因此这是最不可取的解决方案。
...
目前，全球正在发生一场变革。在世界各地，电网正在由主要的化石燃料发电转变为风能和太阳能等低碳发电方式。这是我们实现全球减排目标的最大希望之一。作为绿色软件从业者，让我们一起看看可以通过哪些方式来帮助加速这一转变。

转型的主要驱动力是经济而非任何可持续发展目标。可再生能源之所以胜出，是因为它们的成本更低，并且随着时间的推移，价格会越来越低廉。为了助力转型加速，我们需要让可再生能源发电厂更有利可图，让化石燃料发电厂更无利可图。实践这一点的最好的办法即当电力来自可再生能源等低碳能源时，多用电；当电力来自高碳能源时，少用电。
...
空间转移是指将计算转移到当前碳强度较低的另一个物理位置。这可能是一个天然碳能源较低的地区。例如，根据季节移动到不同的半球以获得更多的日照时间。
