...
<Quiz
  QuizList={[
    ...
    },
    {
      ...
      answers: [
        {
          text: "Compensar tus emisiones de carbono utilizando un contrato financiero.",
          isCorrect: false,
        },
        {
