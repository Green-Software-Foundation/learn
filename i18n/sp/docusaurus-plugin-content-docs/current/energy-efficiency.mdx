...
Los profesionales o practicantes del software verde asumen la responsabilidad de la energía consumida por sus productos y los diseñan para consumir la menos posible. Debemos asegurarnos de que en cada paso del proceso, haya el menor desperdicio posible y que la mayor parte de la energía se destine al siguiente paso.
