...
Un practicante (comúnmente referido como profesional) del software es cualquier persona involucrada en la práctica de crear, implementar o gestionar una aplicación de software. Esto incluye, entre otros, lo siguiente:


- Desarrolladores
- DevOps
- Testers o aseguradores de la calidad
- Arquitectos
...
- Si desea obtener un certificado de finalización, realizar el examen a través de *Linux Foundation*.
...
- Cómo medir las emisiones de software utilizando el protocolo de gases de efecto invernadero (GHG) o la especificación de intensidad de carbono del software (SCI).
- Los diferentes tipos de objetivos climáticos corporativos para que pueda alinear tus propuestas de software verde para ayudar a cumplir los compromisos públicos de su organización.
